...
""",
    ...
    pairing_approve_secondary_parser = pairing_sub.add_parser(
        "approve-secondary", help="Approve a secondary-channel code via primary"
    )
    pairing_approve_secondary_parser.add_argument(
        "platform", help="Platform name (telegram, discord, slack, whatsapp)"
    )
    pairing_approve_secondary_parser.add_argument("code", help="Pairing code to approve")
